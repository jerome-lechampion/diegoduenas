                        ...
                        $("#demo11").animatedModal11();
                          $("#demo12").animatedModal12();
                            $("#demo13").animatedModal13();
                              $("#demo14").animatedModal14();
                                $("#demo15").animatedModal15();
                                  $("#demo16").animatedModal16();
                                    $("#demo17").animatedModal17();
                                      $("#demo18").animatedModal18();
                                        $("#demo19").animatedModal19();
                                          $("#demo20").animatedModal20();
                                            $("#demo21").animatedModal21();
                                              $("#demo22").animatedModal22();
                                                $("#demo23").animatedModal23();
                                                  $("#demo24").animatedModal24();
